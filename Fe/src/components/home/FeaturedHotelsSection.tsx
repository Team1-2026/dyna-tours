...
export const FeaturedHotelsSection: React.FC<FeaturedHotelsSectionProps> = ({ hotels }) => {
  ...
  const tabs = ['Luxury', 'Beach', 'Resort', 'Staycation', 'Business'];
  ...
  const sourceHotels = hotels && hotels.length > 0 ? hotels : (defaultHotels as any);
    ...
    <section className="bg-slate-50 py-20 text-slate-900 relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sourceHotels.slice(0, 4).map((hotel: any, idx: number) => {
