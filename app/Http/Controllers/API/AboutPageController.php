...
class AboutPageController extends Controller
{
    ...
    public function show(): JsonResponse
    {
        ...
        if (!$page) {
            $page = AboutPage::create([
                ...
                'founder_image' => '/images/jomy_milbin.jpg?v=2',
                ...
                'director2_image' => '/images/thomas_john.jpg?v=2',
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'director2_name' => 'nullable|string',
            'director2_title' => 'nullable|string',
            'director2_image' => 'nullable|string',
            'director2_message' => 'nullable|string',
            'director2_quote' => 'nullable|string',
            'director2_signature' => 'nullable|string',
            'story_subheading' => 'nullable|string',
            'services_subtext' => 'nullable|string',
            'partner_image_1' => 'nullable|string',
            'partner_image_2' => 'nullable|string',
            'partner_image_3' => 'nullable|string',
